...
public class StallCreationHandler implements VillagerRegistry.IVillageCreationHandler {
	...
	public StructureVillagePieces.PieceWeight getVillagePieceWeight(Random random, int i) {
		return new StructureVillagePieces.PieceWeight(ComponentVillageStall.class, Taverns.config.weightStalls, MathHelper.getRandomIntegerInRange(random, 0, 1));
	}
