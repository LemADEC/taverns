...
public class ComponentVillageChickencoop extends ComponentVillageBase {
	...
	public static Object buildComponent(StructureVillagePieces.Start startPiece, List pieces, Random random, int x, int y, int z, int direction, int type) {
		StructureBoundingBox structBB = StructureBoundingBox.getComponentToAddBoundingBox(x, y, z, 0, 0, 0, 7, 5, 5, direction);
	...
	public ComponentVillageChickencoop(StructureVillagePieces.Start startPiece, int type, Random rnd, StructureBoundingBox structBB, int direction) {
		...
		this.chckenSpawned = rnd.nextInt(2);
	}
	
	@Override
	protected void func_143012_a(NBTTagCompound par1NBTTagCompound) {
		super.func_143012_a(par1NBTTagCompound);
		par1NBTTagCompound.setInteger("ChickenSpawned", this.chckenSpawned);
	}
	
	@Override
	protected void func_143011_b(NBTTagCompound par1NBTTagCompound) {
		super.func_143011_b(par1NBTTagCompound);
		this.chckenSpawned = par1NBTTagCompound.getInteger("ChickenSpawned");
	}
	...
	public boolean addComponentParts(World world, Random random, StructureBoundingBox bb) {
		if (this.averageGroundLevel < 0) {
			...
			this.boundingBox.offset(0, this.averageGroundLevel - this.boundingBox.maxY + 5 - 2, 0);
		}
		...
		fill(world, bb, 0, 0, 0, 7, 6, 5, BiomeSpecificBlock.air, BiomeSpecificBlock.air);
		...
		fill(world, bb, 0, 0, 0, 7, 0, 5, dirt, dirt);
		fill(world, bb, 3, 0, 2, 6, 0, 3, gravel, gravel);
		...
		this.chckenSpawned += spawnEntity(world, bb, 4, 2, 3, 1 - this.chckenSpawned);
		this.chckenSpawned += spawnEntity(world, bb, 5, 2, 3, 2 - this.chckenSpawned);
		this.chckenSpawned += spawnEntity(world, bb, 6, 2, 3, 3 - this.chckenSpawned);
