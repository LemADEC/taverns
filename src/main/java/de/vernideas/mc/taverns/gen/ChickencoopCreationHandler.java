...
public class ChickencoopCreationHandler implements VillagerRegistry.IVillageCreationHandler {
	...
	public StructureVillagePieces.PieceWeight getVillagePieceWeight(Random random, int i) {
		return new StructureVillagePieces.PieceWeight(ComponentVillageChickencoop.class, Taverns.config.weightChickencoop, MathHelper.getRandomIntegerInRange(random, 0, 1));
	}
